...
from DataProcess.mydata_preprocess import mydata_preprocess
...
class DataProcess(object):
    def __init__(self,
                 data_type='mydata',
                 max_len=100,
                 model='bert',  # 'other''bert' bert 数据处理需要单独进行处理
                 ):
        """
        ...
        with open(file_path, 'r', encoding='UTF-8') as f:
            ...
            for line in f:
                if line != '\n':
                    ...
                    line_data_ids.append(w_index)  # word index
